...
require_once STEPBYSTEP_PlUGIN_DIR.'/includes/common/TestPluginAutoload.php';
require_once STEPBYSTEP_PlUGIN_DIR.'/includes/TestPlugin.php';

register_activation_hook( __FILE__, array('includes/TestPlugin', 'activation') );
register_deactivation_hook( __FILE__, array('includes/TestPlugin', 'deactivation') );
